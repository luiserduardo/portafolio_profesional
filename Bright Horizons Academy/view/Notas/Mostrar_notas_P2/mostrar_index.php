...
<body>
    ...
    <div id="centrado">
        ...
        <section>
            ...
            <section class="opciones-generar" id="opcionesGenerar">
                ...
                <form action="../generar/pdf/generar_pdf.php" method="post" id="abrirPDF">
                ...
                <!-- Para generar excel -->
                <form action="../generar/excel/generar_excel.php" method="post" id="abrirExcel">
                    <input type="hidden" name="gradeid" id="gradeid">
                    <input type="hidden" name="subjectid" id="subjectid">
    ...
    <script src="../generar/Js/pdf_excel_1.js"></script>
    <footer class="footer">
