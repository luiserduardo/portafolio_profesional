...
<header class="hero">
    ...
    <div id="centrado">
        ...
        <section class="opciones-generar" id="opcionesGenerar">
            ...
            <form action="../generar/pdf/generar_pdf3.php" method="post" id="abrirPDF">
                <input type="hidden" name="gradeid" id="gradeid">
                <input type="hidden" name="subjectid" id="subjectid">
                <input type="hidden" name="sectionid" id="sectionid">
                <input type="hidden" name="studenid" id="studenid">
                <input type="submit" value="Generar PDF">
            </form>

            <!-- Para generar excel -->
            <form action="../generar/excel/generar_excel3.php" method="post" id="abrirExcel">
                <input type="hidden" name="gradeid" id="gradeid">
                <input type="hidden" name="subjectid" id="subjectid">
                <input type="hidden" name="sectionid" id="sectionid">
                <input type="hidden" name="studenid" id="studenid">
    ...
    <script src="../generar/Js/pdf_excel_3.js"></script>
